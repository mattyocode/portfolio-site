---
title: Switching On The Dark
date: 'February 4, 2022'
description: Some thoughts on dark mode and why it's everywhere
thumbnailUrl: '/img/blog-dark-mode.jpg'
tags: ['industry', 'culture']
---

<h2>Some thoughts on dark mode and why it's everywhere</h2>

[_Originally published on the Space Doctors' blog._](https://space-doctors.com/switching-on-the-dark-why-dark-mode-is-taking-over-our-lives/)

At the time of writing, the tech press is buzzing about [Google Search testing a dark mode version](https://www.theverge.com/2021/2/10/22276553/google-search-dark-mode-desktop) of the internet’s biggest window on the world. This follows recent announcements that Microsoft Word’s dark mode is becoming [even darker](https://www.cnet.com/news/microsoft-words-dark-mode-brings-on-even-more-darkness/) (dimming the canvas/page as well as the background), as is [Twitter’s](https://www.theverge.com/2021/2/3/22265306/twitter-dark-mode-dim-lights-out-black-darker-light-settings) – moving from a dark blue to black.

Even the [White House](https://techcrunch.com/2021/01/20/white-house-dark-mode-biden-admin-refreshes-presidencys-website-vows-accessibility/) has used its inauguration refresh to welcome both Biden and a new dark mode, challenging the supremacy of the white webpage background and adding some fashionable flair to the .gov domain.
...
The most obvious reason for this increasing popularity is surely dark mode’s primary promise: reducing the impact of screen time on our eyes. According to [one study](https://www.theguardian.com/world/2021/jan/22/children-health-screen-times-covid-crisis-sleep-eyesight-problems-digital-devices), website and app visits have doubled since January 2020, with a tangible increase in children needing glasses over that time. While the idea that light text on a darker screen means less strain on the eyes is intuitive, [there is evidence](https://www.wired.co.uk/article/dark-mode-chrome-android-ios-science) to suggest it’s actually detrimental when reading for a long period of time.
...
The dark, dynamic interfaces of fictional worlds additionally imply a laser focus – whether that’s ‘hacking the mainframe’ or even risking life and limb on a Tron bike. In our oversaturated, dual-screening world, where [decreasing attention spans](https://www.webwisewording.com/shorter-attention-span-technology/) have been compounded by the pandemic [negatively impacting focus](https://www.newstatesman.com/science-tech/coronavirus/2020/05/how-focus-concentration-pandemic-brain-motivation-apps-pomodoro), it’s unsurprising that UI conventions implying concentration and purpose are appealing.
